<template>
    <div class="description">
        <div class="productDisplay">
            ...
            <div class="imgBlock">
                <img :src="require('@/assets/puds/'+productimg)" alt="">
            </div>
        </div>
        ...
        <div class="productDescription">
            ...
            <div class="buttons">
                ...
                <router-link class="homelink" to="/shakes&puds"><button class="btn">return to shakes</button></router-link>
...
<script>
    import data from '@/assets/pudsShakes.json'
    export default {
        name:'pudsDescription',
        data(){
            return {
